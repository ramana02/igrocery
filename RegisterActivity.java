        ...
        class RegisterUser extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... voids) {
                ...
                String s = rh.sendPostRequest
                        ("https://shaunmhaathy.000webhostapp.com/insert_registrationnew.php",hashMap);
                return s;
            }
        ...
        private void makeRequest(final String encoded_string, final String image_name) {
            class UploadAll extends AsyncTask<Void, Void, String> {
                ...
                protected String doInBackground(Void... params) {
                    ...
                    String s = rh.sendPostRequest("https://shaunmhaathy.000webhostapp.com/insert_registrationnew.php", hashMap);
                    return s;
                }
